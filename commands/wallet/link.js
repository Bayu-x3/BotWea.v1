...
module.exports = async function handleLinkCommands(message) {
  const linkGet = message.body.split(' ')[1];
  ...
  const apiUrl = `http://47.88.53.4:3333/api/ewallet/linkaja/${linkGet}`;
